...
>>>>>>> 80aa31a2bf1d8e973c3530e4408a42e02959c16b
...
void arretCallback(const std_msgs::Bool::ConstPtr& msg)
{
    ...
    if (msg->data) {
        ROS_INFO("Motif détecté, arrêt du robot.");
        lin = 0.0;  // Arrêter le robot
        ang = 0.0;
    } else {
        ROS_INFO("Pas de motif, poursuite de la navigation.");
        //lin = 0.2;  // Continuer à avancer
        //ang = 0.0;  // Pas de rotation
    }
}
